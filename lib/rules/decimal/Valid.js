...
/*#__PURE__*/
function (_BaseRule) {
  _inherits(Valid, _BaseRule);

  function Valid() {
    var errorText = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Value must be valid number';

    _classCallCheck(this, Valid);

    return _possibleConstructorReturn(this, _getPrototypeOf(Valid).call(this, errorText));
  }
